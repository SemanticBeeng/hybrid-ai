...
- `isolation-verification.md`: verify runtime isolation, host-level verification tooling consistency, and the target state where all formal isolation checks pass
