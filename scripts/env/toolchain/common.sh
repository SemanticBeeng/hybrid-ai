...
# shellcheck disable=SC1090
source "$PROJECT_ROOT/scripts/env/toolchain/nix_flox_env.sh"
# shellcheck disable=SC1090
source "$PROJECT_ROOT/scripts/env/toolchain/xdg_env.sh"
# shellcheck disable=SC1090
source "$PROJECT_ROOT/scripts/env/toolchain/python_paths.sh"
# shellcheck disable=SC1090
source "$PROJECT_ROOT/scripts/env/toolchain/swift_paths.sh"
# shellcheck disable=SC1090
